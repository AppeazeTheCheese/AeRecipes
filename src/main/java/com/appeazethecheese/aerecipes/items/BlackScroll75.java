...
public class BlackScroll75 extends ItemBase{
    private static final int SuccessRate = 75;
    @Override
    ...
    public ShapedRecipe GetRecipe(JavaPlugin creator) {
        ...
        recipe.setIngredient('I', new RecipeChoice.ExactChoice(new BlackScroll50().CreateItem()));
