...
public class BlackScroll100 extends ItemBase{
    private static final int SuccessRate = 100;
    @Override
    ...
    public ShapedRecipe GetRecipe(JavaPlugin creator) {
        ...
        recipe.setIngredient('I', new RecipeChoice.ExactChoice(new BlackScroll75().CreateItem()));
